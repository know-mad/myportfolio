module.exports = {
  ...
  plugins: [
    ...
    options: {
      google: {
        families: ['Audiowide: 400,500,600,700,800,900', 'Montserrat: 400,500,600,700,800,900']
      }
    }
    },
    ...
    `gatsby-plugin-sharp`,
    {
      ...
      options: {
        ...
        theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `src/images/color-logo.svg`,// This path is relative to the root of the site.
      },
    },
    {
